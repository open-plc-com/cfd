...
#include "myframe_static_events.cpp"
...
BEGIN_EVENT_TABLE( MyFrame, MyFrameFB )
	EVT_MENU( ID_EDIT_CONF,				MyFrame::OnTool_Edit_Conf )

//	EVT_MENU( 	ID_DEV_ADD_ROW			MyFrame::OnTool_Dev_Add_Row )
//	EVT_MENU( 	ID_DEV_DEL_ROW			MyFrame::OnTool_Dev_Del_Row )
//	EVT_MENU( 	ID_DEV_ROW_UP			MyFrame::OnTool_Dev_Row_Up )
//	EVT_MENU( 	ID_DEV_ROW_DOWN			MyFrame::OnTool_Dev_Row_Down )
//	EVT_MENU( 	ID_DEV_SEARCH			MyFrame::OnTool_Dev_Row_Search )
//	EVT_MENU( 	ID_DEV_RUN				MyFrame::OnTool_Dev_Row_Run )

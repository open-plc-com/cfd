...
MyFrameFB::MyFrameFB( wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
    ...
    m_fbd_tool_fb = m_fbd_tool->AddTool( ID_FBD_FB, wxT("tool"), wxBitmap( add_block_xpm ), wxNullBitmap, wxITEM_RADIO, wxT("Function Block"), wxEmptyString, NULL );
    m_fbd_tool_connect = m_fbd_tool->AddTool( ID_FBD_CONNECT, wxT("tool"), wxBitmap( add_connection_xpm ), wxNullBitmap, wxITEM_RADIO, wxT("Connector"), wxEmptyString, NULL );
    m_fbd_tool->Realize();
...
ObjPropsFB::ObjPropsFB( wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    m_splitter->SplitHorizontally( m_panel6, m_panel7, 320 );
...
ConnectPropsFB::ConnectPropsFB( wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    sbSizer = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, wxT("Type") ), wxVERTICAL );
    m_radio_btn1 = new wxRadioButton( sbSizer->GetStaticBox(), wxID_ANY, wxT("Connector"), wxDefaultPosition, wxDefaultSize, 0 );
    sbSizer->Add( m_radio_btn1, 0, wxALL, 5 );
    m_radio_btn2 = new wxRadioButton( sbSizer->GetStaticBox(), wxID_ANY, wxT("Continue"), wxDefaultPosition, wxDefaultSize, 0 );
    sbSizer->Add( m_radio_btn2, 0, wxALL, 5 );
    bSizer19->Add( sbSizer, 0, wxLEFT, 5 );
    wxBoxSizer *bSizer2;
    bSizer2 = new wxBoxSizer( wxHORIZONTAL );
    m_static_text1 = new wxStaticText( this, wxID_ANY, wxT("Name:"), wxDefaultPosition, wxDefaultSize, 0 );
    m_static_text1->Wrap( -1 );
    bSizer2->Add( m_static_text1, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
    m_name = new wxTextCtrl( this, wxID_ANY, wxT("CONNECTOR"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer2->Add( m_name, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
    bSizer19->Add( bSizer2, 0, wxEXPAND, 5 );
    gSizer->Add( bSizer19, 1, wxEXPAND, 5 );
    bSizer3 = new wxBoxSizer( wxVERTICAL );
    m_staticText2 = new wxStaticText( this, wxID_ANY, wxT("Preview"), wxDefaultPosition, wxDefaultSize, 0 );
    m_staticText2->Wrap( -1 );
    bSizer3->Add( m_staticText2, 0, wxALL, 5 );
    m_panel = new wxPanel( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
    wxBoxSizer *bSizer29;
    bSizer29 = new wxBoxSizer( wxVERTICAL );
    m_bitmap = new wxStaticBitmap( m_panel, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBORDER_SIMPLE );
    bSizer29->Add( m_bitmap, 1, wxEXPAND, 5 );
    m_panel->SetSizer( bSizer29 );
    m_panel->Layout();
    bSizer29->Fit( m_panel );
    bSizer3->Add( m_panel, 1, wxEXPAND|wxRIGHT, 5 );
    gSizer->Add( bSizer3, 1, wxEXPAND, 5 );
    bSizer1->Add( gSizer, 1, wxEXPAND, 5 );
    wxBoxSizer *bSizer4;
    bSizer4 = new wxBoxSizer( wxHORIZONTAL );
    m_button_ok = new wxButton( this, wxID_ANY, wxT("Ok"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer4->Add( m_button_ok, 0, wxALL, 5 );
    m_button_cancel = new wxButton( this, wxID_ANY, wxT("Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer4->Add( m_button_cancel, 0, wxALL, 5 );
    bSizer1->Add( bSizer4, 0, wxALIGN_RIGHT, 5 );
    this->SetSizer( bSizer1 );
    this->Layout();
    this->Centre( wxBOTH );
    m_radio_btn1->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConnectPropsFB::OnRadioButton1 ), NULL, this );
    m_radio_btn2->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConnectPropsFB::OnRadioButton2 ), NULL, this );
    m_name->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( ConnectPropsFB::OnText ), NULL, this );
    m_button_ok->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ConnectPropsFB::onOK ), NULL, this );
    m_button_cancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ConnectPropsFB::OnCANCEL ), NULL, this );
}
ConnectPropsFB::~ConnectPropsFB()
{
    m_radio_btn1->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConnectPropsFB::OnRadioButton1 ), NULL, this );
    m_radio_btn2->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConnectPropsFB::OnRadioButton2 ), NULL, this );
    m_name->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( ConnectPropsFB::OnText ), NULL, this );
    m_button_ok->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ConnectPropsFB::onOK ), NULL, this );
    m_button_cancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ConnectPropsFB::OnCANCEL ), NULL, this );
}
VarPropsFB::VarPropsFB( wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    m_text_1 = new wxStaticText( this, wxID_ANY, wxT("Class"), wxDefaultPosition, wxDefaultSize, 0 );
    m_text_1->Wrap( -1 );
    bSizer24->Add( m_text_1, 0, wxTOP|wxRIGHT|wxLEFT, 5 );
    wxArrayString m_choiceChoices;
    m_choice = new wxChoice( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceChoices, 0 );
    m_choice->SetSelection( 0 );
    bSizer24->Add( m_choice, 0, wxALL|wxEXPAND, 5 );
    gSizer3->Add( bSizer24, 1, wxEXPAND, 5 );
    wxBoxSizer *bSizer25;
    bSizer25 = new wxBoxSizer( wxVERTICAL );
    m_text_3 = new wxStaticText( this, wxID_ANY, wxT("Variable"), wxDefaultPosition, wxDefaultSize, 0 );
    m_text_3->Wrap( -1 );
    bSizer25->Add( m_text_3, 0, wxTOP|wxRIGHT|wxLEFT, 5 );
    m_text = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY );
    bSizer25->Add( m_text, 0, wxTOP|wxRIGHT|wxLEFT|wxEXPAND, 5 );
    m_list = new wxListBox( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, NULL, 0 );
    bSizer25->Add( m_list, 1, wxEXPAND|wxBOTTOM|wxRIGHT|wxLEFT, 5 );
    ...
    m_text_2 = new wxStaticText( this, wxID_ANY, wxT("Preview"), wxDefaultPosition, wxDefaultSize, 0 );
    m_text_2->Wrap( -1 );
    bSizer23->Add( m_text_2, 0, wxTOP|wxRIGHT|wxLEFT, 5 );
    m_panel = new wxPanel( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
    wxBoxSizer *bSizer30;
    bSizer30 = new wxBoxSizer( wxVERTICAL );
    m_bitmap = new wxStaticBitmap( m_panel, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize( -1,80 ), wxBORDER_SIMPLE );
    bSizer30->Add( m_bitmap, 1, wxEXPAND, 5 );
    m_panel->SetSizer( bSizer30 );
    m_panel->Layout();
    bSizer30->Fit( m_panel );
    bSizer23->Add( m_panel, 1, wxEXPAND | wxALL, 5 );
    wxBoxSizer *bSizer26;
    bSizer26 = new wxBoxSizer( wxHORIZONTAL );
    m_button_ok = new wxButton( this, wxID_ANY, wxT("Ok"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer26->Add( m_button_ok, 0, wxALL, 5 );
    m_button_cancel = new wxButton( this, wxID_ANY, wxT("Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer26->Add( m_button_cancel, 0, wxALL, 5 );
    bSizer23->Add( bSizer26, 0, wxALIGN_RIGHT, 5 );
    this->SetSizer( bSizer23 );
    this->Layout();
    this->Centre( wxBOTH );
    m_choice->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( VarPropsFB::OnChoice ), NULL, this );
    m_list->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( VarPropsFB::OnListBox ), NULL, this );
    m_button_ok->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( VarPropsFB::onOK ), NULL, this );
    m_button_cancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( VarPropsFB::OnCANCEL ), NULL, this );
}
VarPropsFB::~VarPropsFB()
{
    m_choice->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( VarPropsFB::OnChoice ), NULL, this );
    m_list->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( VarPropsFB::OnListBox ), NULL, this );
    m_button_ok->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( VarPropsFB::onOK ), NULL, this );
    m_button_cancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( VarPropsFB::OnCANCEL ), NULL, this );
}
CommentPropsFB::CommentPropsFB( wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    this->SetSizeHints( wxDefaultSize, wxDefaultSize );
    wxBoxSizer *bSizer27;
    bSizer27 = new wxBoxSizer( wxVERTICAL );
    m_textCtrl7 = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE );
    bSizer27->Add( m_textCtrl7, 1, wxALL|wxEXPAND, 5 );
    wxBoxSizer *bSizer28;
    bSizer28 = new wxBoxSizer( wxHORIZONTAL );
    m_button_ok = new wxButton( this, wxID_ANY, wxT("Ok"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer28->Add( m_button_ok, 0, wxALL, 5 );
    m_button_cancel = new wxButton( this, wxID_ANY, wxT("Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer28->Add( m_button_cancel, 0, wxALL, 5 );
    bSizer27->Add( bSizer28, 0, wxALIGN_RIGHT, 5 );
    this->SetSizer( bSizer27 );
    this->Layout();
    this->Centre( wxBOTH );
}
CommentPropsFB::~CommentPropsFB()
{
}
